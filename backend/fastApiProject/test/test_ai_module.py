...
posts = [post for post in posts if post['place_type'] == 'view' and post['description'] is not None]

# image_base_dir = "/mnt/c/Users/qc_de/Downloads/images"

# for post in posts:
#     note_id = post['place_id']
#     post['image_list'] = ','.join(list(glob.glob(image_base_dir + "/" + place_id + "/*.jpg")))
